    ...
    <>
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] flex flex-col border border-slate-200">
          ...
          <div className="p-6 border-b flex justify-between items-center">
            <div>
              <h3 className="text-2xl font-bold text-slate-800">評価を投稿</h3>
          ...
          <div className="p-6 flex-1 overflow-y-auto">
            <div className="space-y-6">
              ...
              <div className="p-4 bg-gray-50 rounded-lg">
                <h4 className="font-semibold text-slate-700 mb-1">{project.name}</h4>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full px-4 py-3 border border-slate-200 rounded-lg focus:ring-2 focus:ring-indigo-400 focus:border-indigo-400 resize-none bg-slate-50"
                />
          ...
          <div className="p-6 bg-gray-50 border-t flex justify-end gap-3">
            <button
              onClick={handleClose}
              className="px-6 py-2 border border-slate-200 rounded-lg text-sm font-semibold text-slate-700 hover:bg-slate-100 transition"
            >
              キャンセル
            </button>
            <button
      ...
      {showConfirm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[60]">
          <div className="bg-white rounded-xl p-6 max-w-md mx-4 border border-slate-200">
