        ...
        <div className="space-y-6 text-sm">
          <div className="p-4 border border-slate-200 rounded-lg bg-slate-50">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-1 text-xs">
              <p>
                <span className="font-semibold text-slate-700">クライアント:</span>{' '}
                {selectedProjectForReview.clientName}
              </p>
              <p>
                <span className="font-semibold text-slate-700">総額:</span> {selectedProjectForReview.totalAmount.toLocaleString('ja-JP')} pt
              </p>
