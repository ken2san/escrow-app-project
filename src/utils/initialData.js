...
export const marketCommandItems = [
  { type: 'request', id: 1, title: 'バックエンド開発', by: 'NextGen Mart', value: 400000, nature: 0.9, reward: 400000, popularity: 8, description: 'Eコマースサイトのバックエンド開発をお願いします。Node.jsとGraphQLの経験者を募集しています。', workImage: 'https://images.unsplash.com/photo-1461749280684-dccba630e2f6?auto=format&fit=crop&w=600&q=80', date: '2025-08-10T10:30:00', userComments: [
    { text: 'この値段で受ける人いる？', date: '2025-08-10T11:00:00' },
    { text: '要件もう少し詳しく！', date: '2025-08-10T11:05:00' },
    { text: '面白そうな案件ですね。', date: '2025-08-10T11:10:00' },
    { text: 'この案件は要件が曖昧すぎて、もう少し詳細な仕様や納期、報酬の支払い条件などを明記してもらえると応募しやすいです。', date: '2025-08-10T11:15:00' },
    { text: 'Node.jsとGraphQLの経験者限定とのことですが、具体的なバージョンや開発環境についても教えてください。', date: '2025-08-10T11:20:00' },
    { text: '短納期で高額案件、興味あります！', date: '2025-08-10T11:25:00' }
  ] },
  { type: 'offer', id: 2, title: '高品質なロゴを3案作成します', by: 'Sato Design', value: 50000, nature: 0.2, reward: 50000, popularity: 9, description: 'あなたのビジネスの顔となるロゴを、ヒアリングに基づき3つの異なる方向性で提案します。', workImage: 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=600&q=80', date: '2025-08-12T09:00:00', userComments: [
    { text: 'もう少し安くなりませんか？', date: '2025-08-12T09:10:00' },
    { text: 'サンプル見せてほしい', date: '2025-08-12T09:12:00' },
    { text: 'デザインの方向性は？', date: '2025-08-12T09:15:00' },
    { text: 'ロゴの納品形式（AI, PNG, SVGなど）や修正回数についても事前に知りたいです。', date: '2025-08-12T09:18:00' },
    { text: 'ヒアリングの方法や納期の目安も教えてください。', date: '2025-08-12T09:20:00' },
    { text: '実績や過去の制作例があれば見たいです！', date: '2025-08-12T09:22:00' }
  ] },
  { type: 'request', id: 3, title: 'SNSキャンペーン企画', by: 'Growth Hackers', value: 100000, nature: 0.6, reward: 100000, popularity: 5, description: '秋のセールスプロモーションに向けたSNSキャンペーンの企画と運用をお願いします。', workImage: '', date: '2025-08-13T14:00:00', userComments: [
    { text: 'ターゲット層は？', date: '2025-08-13T14:10:00' },
    { text: 'SNSの種類は？', date: '2025-08-13T14:12:00' },
    { text: '実績が知りたい', date: '2025-08-13T14:15:00' },
    { text: 'キャンペーンのKPIやゴール設定についても明記してほしいです。', date: '2025-08-13T14:18:00' },
    { text: '過去の成功事例や失敗事例があれば参考にしたいです。', date: '2025-08-13T14:20:00' },
    { text: '広告予算や運用体制についても教えてください。', date: '2025-08-13T14:22:00' }
  ] },
