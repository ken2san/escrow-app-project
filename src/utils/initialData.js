...
export const dashboardAllProjects = [
  ...
  },
  {
    ...
    contractStatus: 'active', // Project in progress with contractor assigned
    changeOrders: [],
  ...
  },
  {
    ...
    contractStatus: 'active', // Contract status: draft, under_negotiation, agreed, active, completed
    contractHistory: [
      {
        id: 'ch1',
      ...
      },
      {
        ...
        actor: 'user555',
        actorName: '田中 さとし',
        description: 'マイルストーン2の納期を2日延長するよう提案',
        changes: { field: 'milestones[1].dueDate', oldValue: '2026-02-13', newValue: '2026-02-15' },
      },
      {
        id: 'ch3',
    ...
    milestones: [
      {
        ...
        acceptanceCriteria: 'クライアント承認による要件の確定。主要機能とユーザーフローの合意。',
        additionalWorkTerms: '要件の大幅な変更は追加費用が発生する可能性があります。',
      },
      {
        id: 'job2-m2',
        name: 'UIデザイン',
        ...
        acceptanceCriteria: 'デザインカンプの承認。デザインシステムの完全性確認。プロトタイプでの操作感検証。',
        additionalWorkTerms: 'デザイン修正は2回まで無料。3回目以降は追加費用が発生します。',
      },
      {
        id: 'job2-m3',
        name: '実装・テスト',
        ...
        acceptanceCriteria: '実装の完全性確認。主要ブラウザでの動作検証。アクセシビリティ基準（WCAG 2.1 AA）の遵守確認。',
        additionalWorkTerms: 'ブラウザ対応範囲は Chrome, Firefox, Safari, Edge の最新2バージョン。IE対応は別途見積もり。',
      },
    ],
    contractorRating: null,
    clientRating: {
  ...
  },
  {
    ...
    contractStatus: 'draft', // Project in recruiting phase, contract not yet finalized
    changeOrders: [],
