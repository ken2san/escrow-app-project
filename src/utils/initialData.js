...
export const dashboardAllProjects = [
  ...
  // job103
  {
    ...
    deliverableDetails: '各記事2000字以上。指定キーワードを適切に含み、読者の検索意図に合致する内容であること。コピーコンテンツでないこと。',
  ...
  // ...existing code for all other projects from backup (id: 1, 4, job_dispute_01, job105, job106)...
  // id: 1
  {
    id: 1,
    name: '企業ロゴリニューアルプロジェクト',
  ...
  // id: 4
  {
    ...
    milestones: [
      ...
      },
      {
        ...
        status_en: 'In Progress',
        dueDate: '2025-06-25',
        description: '具体的な改善UI案（3パターン）と主要画面のワイヤーフレームを作成。',
        description_en: 'Create 3 specific UI improvement ideas and wireframes for the main screens.',
        submittedFiles: [],
        feedbackHistory: [],
      },
    ...
    imageUrl: 'https://placehold.co/600x400/3B82F6/FFFFFF?text=UI%E6%94%B9%E5%96%84%E6%8F%90%E6%A1%88',
    allowSubcontracting: true,
  },
  // job_dispute_01
  {
